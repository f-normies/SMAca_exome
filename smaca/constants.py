...
POSITIONS = {
    ...
    REF_HG38: {
        ...
        "GENES": {
            'METTL25B': ['1', 156736157, 156736584],
            'THADA': ['2', 43570387, 43570515],
            'ALS2': ['2', 201740609, 201741854],
            'DHX36': ['3', 154272545, 154276356],
            'SND1': ['7', 127904625, 127904819],
            'PATL1': ['11', 59647753, 59647913],
            'PITRM1': ['10', 3156929, 3157531]
        },
        "SMN1_POS": {
